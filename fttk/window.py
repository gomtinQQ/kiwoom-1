...
class Window(QMainWindow):
    ...
    def create_label(self):
        ...
        self.quantity_label()
        self.maximum_profit_tick_label()
        self.maximum_loss_tick_label()
    ...
    def create_text_box(self):
        ...
        self.maximum_profit_tick_box = self.set_maximum_profit_tick_box()
        self.maximum_loss_tick_box = self.set_maximum_loss_tick_box()
    ...
    def set_event_driven(self):
        ...
        self.maximum_profit_tick_box.textChanged.connect(self.set_maximum_profit_tick)
        self.maximum_loss_tick_box.textChanged.connect(self.set_maximum_loss_tick)
    ...
    def set_maximum_profit_tick(self):
        try:
            maximum_profit_tick = self.maximum_profit_tick_box.text()
            self.hts.set_maximum_profit_tick(int(maximum_profit_tick))
        except ValueError:
            pass

    def set_maximum_loss_tick(self):
        try:
            maximum_loss_tick = self.maximum_loss_tick_box.text()
            self.hts.set_maximum_loss_tick(int(maximum_loss_tick))
        except ValueError:
            pass
    ...
    def set_switching_strategy(self):
        try:
            ...
            self.hts.set_swtiching_strategy(int(switching_strategy))
        except ValueError:
            pass
    ...
    def set_maximum_profit_tick_box(self):
        textbox = QLineEdit(self)
        textbox.move(440, 270)
        textbox.resize(150, 40)
        return textbox

    def set_maximum_loss_tick_box(self):
        textbox = QLineEdit(self)
    ...
    def maximum_profit_tick_label(self):
        label = QLabel(self)
        label.move(340, 270)
        label.resize(230, 40)
        label.setText('최대 익절 틱')
        return label

    def maximum_loss_tick_label(self):
        label = QLabel(self)
        label.move(340, 320)
        label.resize(230, 40)
        label.setText('최대 손절 틱')
        return label
